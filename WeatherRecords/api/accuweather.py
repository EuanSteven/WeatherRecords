...
def main():
    ...
    url = f'http://dataservice.accuweather.com/forecasts/v1/hourly/1hour/330324?apikey=zOZBJisehyJcKLYClWvVCbIRN49qYzlO&language=en-gb&details=true&metric=true'
